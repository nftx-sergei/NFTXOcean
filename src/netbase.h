...
enum Network
{
    ...
    /// A set of addresses that represent the hash of a string or FQDN. We will (!) use
    ...
    private:
        ...
        void UnserializeV2Stream(Stream& s)
        {
            ...
            if (SetNetFromBIP155Network(bip155_net, address_size)) {
                ...
                /*  TODO: should clean this issue / case

                    s >> MakeSpan(m_addr);

                    that was in original sources, unfortunatelly it don't want to compile with c++11 and gives the
                    following error:

                    netbase.h:396:30: error: cannot bind non-const lvalue reference of type ‘Span<unsigned char>&’ to an rvalue of type ‘Span<unsigned char>’
                    396 |                 s >> MakeSpan(m_addr);
                        |                      ~~~~~~~~^~~~~~~~
